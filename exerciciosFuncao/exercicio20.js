function sacarDinheiro(valorSaque) {
    ...
    let contador5 = 0
    let contador1 = 0
    let valorNota = tirarUmaNota(valorSaque)
...
function elaborarResultado(contador100, contador50, contador10, contador5, contador1) {
    let resultado = `Voce sacou ${saqueTotal} reais. `
...
console.log(sacarDinheiro(10))
console.log(sacarDinheiro(67))
